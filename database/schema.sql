...
-- Compatible PostgreSQL 12+. Exécuter avec : psql -U minilib_user -dminilib - f database / schema.sql -- Suppression dans l'ordre inverse des dépendances (pour reset propre)
